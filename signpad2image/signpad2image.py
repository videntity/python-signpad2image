...
def s2if(jsonsig, output_image="signature.png", input_image="blanksig.png",
            pincolor=(0,0,255)):
...
def s2i(jsonsig, input_image="blanksig.png", pincolor=(0,0,255),
        force_no_sig_image=False, nosig_image="nosig.png"):
